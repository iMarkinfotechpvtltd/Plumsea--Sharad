...
/****************END OF CODE FOR WORDPRESS LOGO*****************/


/************** START CODE USE FOR PUT ACTIVE CLASS ON MENU *******************/
...
/************** END OF CODE USE FOR PUT ACTIVE CLASS ON MENU *******************/


/************** START CODE USE FOR ADD IMAGE SIZE FUNCTION *******************/

add_image_size('logo_image_size',723,128);
add_image_size('expert_section_banner_image_size',1920,766);
add_image_size('profile_image_size',197,195);
add_image_size('ourwork_image_size',461,384);
add_image_size('ourwork_internal_image_size',706,648);

/************** END OF CODE USE FOR ADD IMAGE SIZE FUNCTION  *******************/


/************** START CODE FOR CREATE CUSTOM POST ATTORNEYS ******************/ 

function codex_attorneys() {
  $labels = array(
    'name' => 'Attorneys',
    'singular_name' => 'Attorneys',
    'add_new' => 'Add Attorneys',
    'add_new_item' => 'Add New Attorneys',
...
add_action( 'init', 'codex_attorneys' ); 

/************** END OF CODE FOR CREATE CUSTOM POST ATTORNEYS ******************/ 


/************** START CODE FOR CREATE CUSTOM POST OUR WORK ******************/ 

function codex_ourwork() {
  $labels = array(
    'name' => 'Ourwork',
    'singular_name' => 'Ourwork',
    'add_new' => 'Add Ourwork',
    'add_new_item' => 'Add New Ourwork',
    'edit_item' => 'Edit Ourwork',
    'new_item' => 'New Ourwork',
    'all_items' => 'All Ourwork',
    'view_item' => 'View Ourwork',
    'search_items' => 'Search Ourwork',
    'not_found' =>  'No Ourwork found',
    'not_found_in_trash' => 'No Ourwork found in Trash', 
    'parent_item_colon' => '',
    'menu_name' => 'Ourwork'
  );
...
add_action( 'init', 'codex_ourwork' ); 

/************** END OF CODE FOR CREATE CUSTOM POST OUR WORK ******************/ 
